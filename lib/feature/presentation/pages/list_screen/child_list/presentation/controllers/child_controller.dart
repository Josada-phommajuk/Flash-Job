...
import 'package:flash_job/feature/presentation/pages/list_screen/child_list/dialogs/child_confirmation_dialog.dart';
import 'package:flash_job/feature/presentation/pages/list_screen/clean_list/data/repositories/user_repository.dart' show UserRepository;
  ...
  void showConfirmationDialog(BuildContext context, String serviceType, String serviceTitle) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return ChildConfirmationDialog(
